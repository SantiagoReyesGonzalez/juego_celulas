...
export const SPECIES_CATALOG: Record<string, BacteriaSpecies> = {
  ...
  rhodospirillum_bio: {
    ...
    role: CellRole.METABOLIC_HARVESTER,
    icon: '🔋',
    description: 'Pigmentos fotosintéticos y respiratorios que regeneran salud y ATP de forma pasiva continua.',
    morphology: CellMorphology.SPIRILLUM,
    mass: 2.5,
    hp: 290,
    shield: 135,
  ...
  titan_magneto_emperor: {
    ...
    role: CellRole.APEX_TITAN,
    icon: '👑',
    description: 'Vacuola monumental de 1500 ATP. Magnetiza el medio tisular, atrayendo energía y vitalidad celular a ritmos colosales.',
    morphology: CellMorphology.SPIRILLUM,
    mass: 6.4,
    hp: 1200,
    shield: 540,
